...
def getActivePokemon(browser,actions):
    active_pokemon = browser.find_element_by_name('chooseDisabled')
...
def getInactivePokemon(browser,actions):
    my_pokemon = []
...
def getActiveEnemyPokemon(browser,actions):
    pokemon = {}
